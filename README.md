...
1.  Download the repository (or zip) and upload the plugin files to the `/wp-content/plugins/simple-popular-posts-for-ga4` directory.
...
Users are responsible for the management and security of their own Service Account JSON keys.
The author is not liable for any damages or data leaks caused by the use of this plugin.
